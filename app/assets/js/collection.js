...
var $addNewItem = $('<a href="#" class="btn btn-info">Добавить новый материал</a>');
...
function addRemoveButton ($panel) {
    ...
    var $removeButton = $('<a href="#" class="btn btn-danger" style="margin-top: 10px; margin-bottom: 10px">Удалить</a>');
