 ...
 */
final class Version20221122193843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT NOT NULL, name VARCHAR(50) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE visit ALTER service_status SET DEFAULT \'Активно\'');
    }
