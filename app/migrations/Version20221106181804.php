 ...
 */
final class Version20221106181804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN client.id IS \'(DC2Type:property_id)\'');
        $this->addSql('CREATE TABLE employee (id INT NOT NULL, position_id INT DEFAULT NULL, phone VARCHAR(15) NOT NULL, address VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_5D9F75A1DD842E46 ON employee (position_id)');
        $this->addSql('COMMENT ON COLUMN employee.id IS \'(DC2Type:property_id)\'');
        $this->addSql('COMMENT ON COLUMN employee.position_id IS \'(DC2Type:property_id)\'');
        ...
        $this->addSql('COMMENT ON COLUMN material.id IS \'(DC2Type:property_id)\'');
        ...
        $this->addSql('COMMENT ON COLUMN materials_services.id IS \'(DC2Type:property_id)\'');
        $this->addSql('COMMENT ON COLUMN materials_services.material_id IS \'(DC2Type:property_id)\'');
        $this->addSql('COMMENT ON COLUMN materials_services.service_id IS \'(DC2Type:property_id)\'');
        ...
        $this->addSql('COMMENT ON COLUMN position.id IS \'(DC2Type:property_id)\'');
        ...
        $this->addSql('COMMENT ON COLUMN service.id IS \'(DC2Type:property_id)\'');
        $this->addSql('COMMENT ON COLUMN service.position_id IS \'(DC2Type:property_id)\'');
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, first_name VARCHAR(80) NOT NULL, last_name VARCHAR(80) NOT NULL, middle_name VARCHAR(80) NOT NULL, email VARCHAR(180) NOT NULL, status TEXT DEFAULT \'active\' NOT NULL, passwordHash VARCHAR(255) DEFAULT NULL, role VARCHAR(16) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON "user" (email)');
        $this->addSql('COMMENT ON COLUMN "user".id IS \'(DC2Type:property_id)\'');
        $this->addSql('COMMENT ON COLUMN "user".email IS \'(DC2Type:property_email)\'');
        $this->addSql('COMMENT ON COLUMN "user".role IS \'(DC2Type:property_role)\'');
        ...
        $this->addSql('COMMENT ON COLUMN visit.id IS \'(DC2Type:property_id)\'');
        $this->addSql('COMMENT ON COLUMN visit.service_id IS \'(DC2Type:property_id)\'');
        $this->addSql('COMMENT ON COLUMN visit.employee_id IS \'(DC2Type:property_id)\'');
        $this->addSql('COMMENT ON COLUMN visit.client_id IS \'(DC2Type:property_id)\'');
